<?php
	...
	{
			$sql = "update placement set placement_stats='$_POST[textarea1]'";
...
$sql = "SELECT placement_stats from placement";
...
<div class="div_middle_right_left">
	...
	<form action="edit_placementstats.php" method="post" name="myform" enctype="multipart/form-data">		
	Enter the text :<br>
	<?php
