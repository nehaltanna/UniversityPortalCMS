...
--
-- Host: localhost
-- Generation Time: Feb 14, 2012 at 12:28 AM
...
(268, 'CODE'),
(269, 'CURSOR'),
(270, 'GEOMETRYCOLLECTIONFROMTEXT'),
(271, 'CHAIN'),
(272, 'LOGFILE'),
(273, 'FLUSH'),
(274, 'CREATE'),
...
(311, 'IDENTIFIED'),
(312, 'WRAPPER'),
(313, 'MASTER_SSL_CIPHER'),
(314, 'SQL_SLAVE_SKIP_COUNTER'),
(315, 'BOTH'),
(316, 'BOOL'),
(317, 'YEAR'),
(318, 'MASTER_PORT'),
...
(343, 'SQL_THREAD'),
(344, 'SERVER'),
(345, 'MAX_QUERIES_PER_HOUR'),
(346, 'MASTER_SSL_CERT'),
(347, 'MULTIPOLYGONFROMWKB'),
(348, 'TRANSACTION'),
(349, 'DAY_MINUTE'),
(350, 'STDDEV'),
(351, 'DATE_SUB'),
...
(420, 'DECLARE CURSOR', 23, 'Syntax:\nDECLARE cursor_name CURSOR FOR select_statement\n\nThis statement declares a cursor and associates it with a SELECT\nstatement that retrieves the rows to be traversed by the cursor. The\nrows are fetched later with a FETCH statement. The number of columns\nretrieved by the SELECT statement must match the number of output\nvariables specified in the FETCH statement.\n\nThe SELECT statement cannot have an INTO clause.\n\nCursors must be declared before declaring handlers and after declaring\nvariables and conditions.\n\nMultiple cursors may be declared in a stored program, but each cursor\nin a given block must have a unique name. For an example, see\nhttp://dev.mysql.com/doc/refman/5.5/en/cursors.html.\n\nFor information available through SHOW statements, it is possible in\nmany cases to obtain equivalent information by using a cursor with an\nINFORMATION_SCHEMA table.\n\nURL: http://dev.mysql.com/doc/refman/5.5/en/declare-cursor.html\n\n', '', 'http://dev.mysql.com/doc/refman/5.5/en/declare-cursor.html'),
...
('localhost', 'root', '', '', 1, '', '2012-02-02 19:10:18'),
('sniper', 'root', '', '', 1, '', '2012-02-02 19:10:18');
...
('localhost', 'root', '*BA8BCDD54AFB591FC8F077775EF790A1EB087F09', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('sniper', 'root', '*BA8BCDD54AFB591FC8F077775EF790A1EB087F09', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('127.0.0.1', 'root', '*BA8BCDD54AFB591FC8F077775EF790A1EB087F09', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('::1', 'root', '*BA8BCDD54AFB591FC8F077775EF790A1EB087F09', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('localhost', 'tops', '*39C549BDECFBA8AFC3CE6B948C9359A0ECE08DE2', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', NULL);
